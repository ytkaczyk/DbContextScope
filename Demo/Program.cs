  ...
  public class Program
  {
    public static async Task Main(string[] args)
    {
      ...
      using (var scope = serviceProvider.CreateScope())
      {
        ...
        var dbContextScopeFactory = scopeServiceProvider.GetRequiredService<IDbContextScopeFactory>();

        var userCreationService = scopeServiceProvider.GetRequiredService<UserCreationService>();
        var userQueryService = scopeServiceProvider.GetRequiredService<UserQueryService>();
        var userEmailService = scopeServiceProvider.GetRequiredService<UserEmailService>();
        var userCreditScoreService = scopeServiceProvider.GetRequiredService<UserCreditScoreService>();
